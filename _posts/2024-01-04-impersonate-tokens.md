...
Nesta API, é importante nos atentarmos em três fatores:

- `dwDesiredAccess`: representa o [nível de acesso](https://learn.microsoft.com/pt-br/windows/win32/secauthz/access-rights-for-access-token-objects) do token duplicado. É possível requisitar o mesmo nível de acesso do token original passando o valor "0".
...
bool result = Impersonate.PInvokes.DuplicateTokenEx(
	...
	(uint)Impersonate.PInvokes.TokenAccess.TOKEN_ALL_ACCESS, // especificando total privilégio ao token duplicado
